...
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.
    ...
    info.ai_usage = ['OpenAI Codex was used for repository inspection, controller ', ...
                     'scaffolding, preliminary tuning support, and report drafting. ', ...
                     'Final MATLAB benchmark execution and numeric result validation ', ...
                     'must be performed by the student before submission.'];
